    ...
    <div class="col-md-12 row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Registrar Novo Desenvolvedor</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('salvar_dev/'.$id_projeto) }}">
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-12">
                                <table class="table">
                                    ...
                                    <tbody id="dev">
                                        ...
                                        <td class="col-lg-1"><input id="name" type="date" class="form-control" name="data_limite"></td>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <a class="btn btn-danger" href="{{ url('detalhes_projeto/'.$id_projeto) }}">
